...
if placeId == 2753915549 or placeId == 4442272183 or placeId == 7449423635 then
	BF = true -- Blox Fruits
elseif placeId == 9555732501 then
	NFS = true -- Nen Fighting Simulator
elseif placeId == 606849621 then
	JB = true -- Jailbreak
elseif placeId == 9603033881 then
	BBT = true -- Bid Battles - Tycoon
else
	print("Game Not Supported!")
end
-- Handler

_G.Color = Color3.fromRGB(134, 255, 247)
...
function library:AddWindow(text,keybind)
	...
	NameHub.Text = text
	NameHub.TextColor3 = Color3.fromRGB(134, 255, 247)
	...
	UserText.TextColor3 = Color3.fromRGB(134, 255, 247)
	...
	function uitab:AddTab(text,image)
		...
		PageButton.MouseButton1Click:Connect(function()
			...
			for i,v in next, ScrollPage:GetChildren() do
				...
				TweenService:Create(
					PageButton,
					TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out),
					{TextColor3 = Color3.fromRGB(134, 255, 247)}
				):Play()
			end
		end)
		...
		function main:AddToggle(text,config,callback)
			...
			ToggleImage2.BackgroundColor3 = Color3.fromRGB(134, 255, 247)
		...
		function main:AddSlider(text,min,max,set,callback)
			...
			Bar.Name = "Bar"
			Bar.Parent = Bar1
			Bar.BackgroundColor3 = Color3.fromRGB(134, 255, 247)
		...
		function main:AddSeperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(173, 173, 173)
			...
			SepLabel.Text = text
			SepLabel.TextColor3 = Color3.fromRGB(134, 255, 247)
			SepLabel.TextSize = 11.000

			Sep2.Name = "Sep2"
			Sep2.Parent = Seperator
			Sep2.BackgroundColor3 = Color3.fromRGB(173, 173, 173)
		...
		function main:AddLine()
			...
			Linee.Name = "Linee"
			Linee.Parent = Line
			Linee.BackgroundColor3 = Color3.fromRGB(173, 173, 173)
...
if BF then
	...
	--------------------------------------------------------------------
	local RenUi = library:AddWindow("Phan Hub",Enum.KeyCode.RightControl)
	--------------------------------------------------------------------
	...
	Main:AddSeperator("Game Settings")
...
if NFS then
	...
	local AutoFarm = RenUi:AddTab("Auto","7251993295")
	local Teleport = RenUi:AddTab("Teleport","6035190846")
	local Misc = RenUi:AddTab("Misc","6034509993")
	--------------------------------------------------------------------

	Main:AddSeperator("Nen Fighting Simulator")
	Main:AddSeperator("Game Settings")
	...
	-- Auto
	AutoFarm:AddSeperator("Auto Settings")
	AutoFarm:AddToggle("Auto Strength",false,function(bool)
		_G.doStr = bool
		if bool then
			doStr()
		end
	...
	AutoFarm:AddToggle("Auto Durability",false,function(bool)
		_G.doDur = bool
		if bool then
			doDur()
		end
	...
	AutoFarm:AddToggle("Auto Agility",false,function(bool)
		_G.doAgi = bool
		if bool then
			doAgi()
		end
	...
	AutoFarm:AddToggle("Auto Nen",false,function(bool)
		_G.doNen = bool
		if bool then
			doNen()
		end
	...
	Teleport:AddToggle("Teleport",false,function(value)
		...
		if _G.TeleportIsland == true then
			repeat wait()
				if _G.SelectIsland == "Whale Island" then
					topos(CFrame.new(-671.700073, 26.4477081, 653.989929, -0.738876343, -0.0231042933, -0.673445284, -0.0115050469, 0.999698877, -0.021674417, 0.673743308, -0.00826668739, -0.738919735))
				elseif _G.SelectIsland == "Hunter Island" then
					topos(CFrame.new(405.320251, 9.52230358, 642.429993, -0.649853408, -2.18734098e-08, -0.760059595, -2.64083528e-08, 1, -6.19932061e-09, 0.760059595, 1.60432716e-08, -0.649853408))
				elseif _G.SelectIsland == "Yorknew City" then
					topos(CFrame.new(129.5, 13.1992435, -840.789978, 0.495373785, 0, 0.868679881, 0, 1, 0, -0.868679881, 0, 0.495373785))
				end
			until not _G.TeleportIsland
		end
		StopTween(_G.TeleportIsland)
...
if JB then
	...
	--------------------------------------------------------------------
	local Main = RenUi:AddTab("Main","6026568198")
	local AutoFarm = RenUi:AddTab("Auto","7044284832")
	local Weapons = RenUi:AddTab("Weapons","7251993295")
	local Vehicle = RenUi:AddTab("Vehicle","6035190846")
	local Misc = RenUi:AddTab("Misc","6034509993")
	--------------------------------------------------------------------

	Main:AddSeperator("Jailbreak")
	Main:AddSeperator("Game Settings")
	...
	--Auto
	AutoFarm:AddSeperator("Coming Soon")
	--Guns
	Weapons:AddSeperator("Weapons")
	Weapons:AddButton("Get All Basic Guns", function()
	...
	Weapons:AddToggle("Gun Mods",false, function(value)
		if value == true then
			for i,v in pairs(getgc(true)) do 
	...
	Weapons:AddToggle("Taser Mods",false, function(value)
		if value == true then
	...
	--Vehicle
	Vehicle:AddSeperator("Vehicle")
	Vehicle:AddSlider("Car Speed",1,500,1,function(value)
		_G.CarSpeed = value
		engine.GetVehiclePacket().GarageEngineSpeed = _G.CarSpeed
	end)
	Vehicle:AddButton("Inf Nitro",false, function(value)
		_G.InfNitro = value
	...
	Misc:AddToggle("No Ragdoll",false,function(value)
		_G.NoRagdoll = value
...
if BBT then
	...
	Main:AddSeperator("Gamepass")
	Main:AddButton("Teleport",function()
		game:GetService("Players").LocalPlayer.Gamepasses.Teleport.Value = true
	end)
	Main:AddButton("VIP",function()
		game:GetService("Players").LocalPlayer.Gamepasses.VIP.Value = true
	end)
	Main:AddButton("Lucky Grading",function()
		game:GetService("Players").LocalPlayer.Gamepasses.LuckyAppraisal.Value = true
	end)
	Main:AddButton("Speedy Offers",function()
		game:GetService("Players").LocalPlayer.Gamepasses.SpeedyOffers.Value = true
	end)
	--Misc
	Misc:AddSeperator("Server")
	Misc:AddButton("Rejoin Server",function()
